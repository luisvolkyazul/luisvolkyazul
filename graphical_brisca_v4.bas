...
530 COLOUR 7
540 PRINT TAB(7,2)"========================="
550 PRINT TAB(8,3)"B R I S C A   for Agon"
560 PRINT TAB(7,4)"========================="
570 COLOUR 3
...
1800 COLOUR 3 : PRINT TAB(4,14)"Thanks for playing Brisca!"
1810 END
1815
1820 REM ============================
...
1840 REM ============================
2000 COLOUR 11
2010 PRINT TAB(0,10)"You lead. Pick slot (1-3):"
2020 GOSUB 6000
...
11110 GCOL 0,6 : PLOT &9C,sx%,sy% : PLOT &9D,sx%,sy%+sr%*3/4
11120 GCOL 0,0 : PLOT &64,sx%-sr%/6,sy%-sr%/6 : PLOT &65,sx%+sr%/6,sy%+sr%/6
11130 RETURN
11140
...
11830 PRINT TAB(tcol%,trow%);"TRUMP"
11832 tcol%=(trX%+8)/32 : trow%=29-((trY%+CH%-40)/34)
11834 COLOUR 1 : PRINT TAB(tcol%,trow%);rS$(trF%)
11836 PRINT TAB(tcol%,trow%+1);sN$(trS%)
...
11950 COLOUR 7 : PRINT TAB(tcol%,trow%);"[";sl%;"]"
11960 NEXT sl%
11970 RETURN
11972
11974 REM ============================
...
12060 COLOUR 7
12070 PRINT TAB(tcol%,trow%+2);"[";sl%;"]"
12080 NEXT sl%
12090 RETURN
12100 COLOUR 1
12110 PRINT TAB(tcol%,trow%);rS$(dF%(pH%(sl%)))
12120 PRINT TAB(tcol%,trow%+1);LEFT$(sN$(dS%(pH%(sl%))),4)
12130 su%=dS%(pH%(sl%))
...
12240 COLOUR 7
12250 PRINT TAB(0,0)"Trick:";trk%;"  You:";pSc%;"  CPU:";cSc%
12270 COLOUR 7
12280 RETURN
12296
12297 REM ============================
...
12299 REM ============================
12300 COLOUR 10
12310 IF pw%=1 THEN PRINT TAB(12,17)"PLAYER wins +";tp%;"pts"
12320 IF pw%=0 THEN PRINT TAB(12,17)"CPU wins +";tp%;"pts"
12330 COLOUR 7
12340 PRINT TAB(12,18)"You:";pSc%;" CPU:";cSc%
12350 PRINT TAB(12,19)"Press any key..."
12360 RETURN
12370
12372 REM ============================
