...
3010 PRINT "====================="
3025 MODE 0
3030 PRINT "Stacking boxes from top to bottom..."
3035 :
3040 REM Stack boxes one at a time, boxes get smaller as they go UP
3045 FOR BOX%=0 TO 55
3050   COL% = BOX% MOD 8
3055   ROW% = BOX% DIV 8
3060   GCOL 0,COL%
3065   X% = ROW%*80 + 10
...
3080   H% = 30 - COL%*2
3085   MOVE X%, Y%
3090   PLOT 101, X%+W%, Y%-H%
3095   FOR D%=1 TO 10000: NEXT D%
3100 NEXT BOX%
3105 :
3110 PRINT ""
3115 PRINT "Demo 3 complete!"
3120 PRINT "Press SPACE to continue..."
3125 REPEAT UNTIL INKEY(0)=32
3130 RETURN
3330 :
3340 REM ============================================================
