  ...
  116 *MOS_SETRTC
  120 REM M% = 24 : BorM$ = "B" : GOTO 300 : REM UNCOMMENT TO SET YOUR DEFAULTS.
  125 REM *VDU 7
  126 INPUT TAB(30,30)"WHAT'S YOUR NAME",name$:CLS
  127 PRINT TAB(10,5)"Hello ";:COLOUR random_colour%+4:PRINTname$;:COLOUR15:PRINT", below are some of the available screen modes."
  ...
  160 REM PRINT TAB(3,10) "MODE  3 = 80x30: 64 colours (640x240) 60hz"
  ...
  255 PRINT TAB(3,18) "MODE 24 = 64X80: 16 colours (640x512) 60hz"
  260 :
  ...
  300 PROC_INITIALIZE
  305 IF M%<7 OR M%=24 THEN 310 ELSE 330
  310 PROC_LOAD_LOGO
  320 PROC_DRAW_LOGO
  330 PROC_INFO_TEXT
  340 PROC_DRAW_COLOUR_PALETTE
  350 PROC_READYUP
  355 FOR i=0 TO 5000:NEXT i:*VDU 7
  356 COLOUR 15: PRINT''TAB((W%-37)/2)"DATE & TIME: ";
  357 *TIME
  358 PRINT'"":REM RND(64):PRINT'""
  360 :
  370 REM NEW : REM CLEAR PROGRAM FROM MEMORY.
  ...
  660 REM COLOUR 1: PROC_PRINT_CHAR_ARRAY((W%-37)/2,3,1)
  670 REM COLOUR 2: PROC_PRINT_CHAR_ARRAY((W%-37)/2,4,2)
 ...
 1022 COLOURrandom_colour%+4:PRINT TAB((W%-17)/2)name$;:COLOUR15:PRINT", Welcome to...":COLOUR9
