  ...
  122 REM COLOUR 15: COLOUR 132: CLS
  125 REM *VDU 7
  126 INPUT TAB(30,31)"WHAT'S YOUR NAME", name$: CLS
  127 REM PRINT TAB(10,5)"Hello ";:COLOUR random_colour%+RND(6):PRINT name$; : COLOUR 15: PRINT ", below are some of the available screen modes."
  130 REM PRINT:PRINT TAB(3,8) "MODE  0 = 80x60: 16 colours"
  140 REM PRINT TAB(3,5) "MODE  1 = 80x60:  4 colours (640x480) 60hz"
  150 REM PRINT TAB(3,6) "MODE  2 = 80x60:  2 colours (640x480) 60hz"
  160 REM PRINT TAB(3,10) "MODE  3 = 80x30: 64 colours"
  ...
  200 REM PRINT TAB(3,12) "MODE  7 = 40x25: 16 colours"
  210 REM PRINT TAB(3,14) "MODE  8 = 40x30: 64 colours"
  ...
  250 REM PRINT TAB(3,16) "MODE 12 = 40X25: 64 colours (320x200) 70hz"
  255 REM PRINT TAB(3,16) "MODE 20 = 64x48: 64 colours"
  256 REM PR. TAB(3,18) "MODE 24 = 80X64: 16 colours"
  260 :
  280 REM INPUT TAB(10,30) "PLEASE PICK A SCREEN MODE"; M%
  285 REM *VDU 7
  290 INPUT TAB(3,31)"Now select B FOR BASIC PROMPT (>) or M FOR MOS PROMPT (*) "; BorM$: CLS
  300 REM PROC_INITIALIZE
  ...
  350 PROC_READYUP
  355 REM FOR i=0 TO 50000:NEXT i:*VDU 7
  ...
  660 COLOUR 2: PROC_PRINT_CHAR_ARRAY((W%-50)/2,3,1)
  670 COLOUR 1: PROC_PRINT_CHAR_ARRAY((W%-50)/2,4,2)
